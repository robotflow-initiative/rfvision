...
class ImVoteNet(Base3DDetector):
    ...
    def __init__(self,
        ...
        if pts_bbox_heads is not None:
            ...
            self.pts_bbox_head_joint = build_head(pts_bbox_head_joint)
            self.pts_bbox_head_pts = build_head(pts_bbox_head_pts)
            self.pts_bbox_head_img = build_head(pts_bbox_head_img)
            self.pts_bbox_heads = [
