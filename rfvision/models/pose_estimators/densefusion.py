from rfvision.models.builder import POSE_ESTIMATORS, build_pose_estimator
import numpy as np
...
class DenseFusion(BaseDetector):
    def __init__(self,
        ...
        self.estimator = build_pose_estimator(estimator)
        self.refiner = build_pose_estimator(refiner)
