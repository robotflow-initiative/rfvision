...
def mask_target(pos_proposals_list, pos_assigned_gt_inds_list, gt_masks_list,
    ...
    Example:
        >>> import rflib
        >>> import rfvision
        >>> from rfvision.core.mask import BitmapMasks
        >>> from rfvision.core.mask.mask_target import *
        >>> H, W = 17, 18
        >>> cfg = rflib.Config({'mask_size': (13, 14)})
...
def mask_target_single(pos_proposals, pos_assigned_gt_inds, gt_masks, cfg):
    ...
    Example:
        ...
        >>> import rfvision
        >>> from rfvision.core.mask import BitmapMasks
        >>> from rfvision.core.mask.mask_target import *  # NOQA
        >>> H, W = 32, 32
        >>> cfg = rflib.Config({'mask_size': (7, 11)})
        >>> rng = np.random.RandomState(0)
