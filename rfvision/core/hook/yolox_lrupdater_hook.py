...
from rflib.runner.hooks import HOOKS
from rflib.runner.hooks.lr_updater import (CosineAnnealingLrUpdaterHook,
                                          annealing_cos)
...
class YOLOXLrUpdaterHook(CosineAnnealingLrUpdaterHook):
    ...
    and CosineAnnealingLrUpdaterHook.
       ...
       2. The exp warmup scheme is different with LrUpdaterHook in rflib
