...
from rflib.cnn import (ConvModule, DepthwiseSeparableConvModule,
                      bias_init_with_prob)
from rflib.ops.nms import batched_nms
from rflib.runner import force_fp32

from rfvision.core import (MlvlPointGenerator, bbox_xyxy_to_cxcywh,
...
class YOLOXHead(BaseDenseHead, BBoxTestMixin):
    ...
    def get_bboxes(self,
        ...
        Args:
            ...
            cfg (rflib.Config, Optional): Test / postprocessing configuration,
