...
from rflib.cnn import ConvModule, bias_init_with_prob, normal_init
from scipy import ndimage
from rfvision.core import InstanceData # tycoer
...
class SOLOv2Head(nn.Module):
    ...
    def solov2_target_single(self, gt_bboxes_raw, gt_labels_raw, gt_masks_raw,
        ...
        for (lower_bound, upper_bound), stride, num_grid \
            ...
            for seg_mask, gt_label, half_h, half_w in zip(
                ...
                seg_mask = rflib.imrescale(seg_mask, scale=1. / output_stride)
    ...
    def get_seg(self,
        ...
        for img_id in range(len(img_metas)):
            ...
            #                              cfg, rescale)
            ########### tycoer ##########
            result = self.get_seg_single(img_meta=img_metas[img_id],
                                         cate_preds=cate_pred_list,
                                         seg_preds=seg_pred_list,
                                         kernel_preds=kernel_pred_list,
    ...
    def get_seg_single(self,
        ...
        results = InstanceData(img_meta) # tycoer
        # overall info.
        h, w, _ = img_shape
        ...
        if len(cate_scores) == 0:
            # return None
            return empty_results(results, cate_scores) # tycoer
