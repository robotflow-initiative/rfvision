...
from rflib.cnn import (ConvModule, bias_init_with_prob, constant_init, is_norm,
                      normal_init)
from rflib.runner import force_fp32

from rfvision.core import (build_anchor_generator, build_assigner,
...
class YOLOV3Head(BaseDenseHead, BBoxTestMixin):
    ...
    def _get_bboxes(self,
        ...
        for i in range(self.num_levels):
            ...
            from rfvision.utils.export import get_k_for_topk
        ...
        # In rfvision, the class_id for background is num_classes.
        # i.e., the last column.
