...
from rflib.cnn import ConvModule, build_conv_layer, constant_init, kaiming_init

from rfvision.core.utils_pose import WeightNormClipHook
...
class TCN(BaseModule):
    ...
    Example:
        >>> from rfvision.components.backbones import TCN
        >>> import torch
