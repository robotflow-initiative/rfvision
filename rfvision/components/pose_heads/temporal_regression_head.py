...
from rflib.cnn import build_conv_layer, constant_init, kaiming_init
from rflib.runner import BaseModule
from rfvision.core import (WeightNormClipHook, compute_similarity_transform,
                         fliplr_regression)
from rfvision.models.builder import HEADS, build_loss


@HEADS.register_module()
class TemporalRegressionHead(BaseModule):
