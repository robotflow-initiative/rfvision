...
from rflib.cnn import ConvModule, build_conv_layer, build_upsample_layer
from rflib.runner import BaseModule, ModuleList, auto_fp16, force_fp32
...
class FCNMaskHead(BaseModule):
    ...
    def loss(self, mask_pred, mask_targets, labels):
        """
        Example:
            >>> from rfvision.models.roi_heads.mask_heads.fcn_mask_head import *  # NOQA
    ...
    def get_seg_masks(self, mask_pred, det_bboxes, det_labels, rcnn_test_cfg,
        ...
        Example:
            ...
            >>> rcnn_test_cfg = rflib.Config({'mask_thr_binary': 0, })
            >>> ori_shape = (H * 4, W * 4)
