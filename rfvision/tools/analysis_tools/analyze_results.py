...
class ResultVisualizer:
    ...
    def evaluate_and_show(self,
        ...
        prog_bar = rflib.ProgressBar(len(results))
        _mAPs = {}
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='RFVision eval image prediction result for each')
...
def main():
    ...
    rflib.check_file_exist(args.prediction_path)
    ...
    outputs = rflib.load(args.prediction_path)
