...
class LoadMultiViewImageFromFiles(object):
    ...
    def __call__(self, results):
        ...
        img = np.stack(
            [rflib.imread(name, self.color_type) for name in filename], axis=-1)
        if self.to_float32:
...
class LoadPointsFromMultiSweeps(object):
    ...
    Args:
        ...
        file_client_args (dict): Config dict of file clients, refer to
            https://github.com/WenqiangX/robotflow/blob/master/robotflow/rflib/fileio/file_client.py
    ...
    def _load_points(self, pts_filename):
        ...
        if self.file_client is None:
            self.file_client = rflib.FileClient(**self.file_client_args)
        try:
...
class LoadAnnotations3D(LoadAnnotations):
    ...
    Args:
        ...
        seg_3d_dtype (dtype, optional): Dtype of 3D semantic masks.
            Defaults to int64
        file_client_args (dict): Config dict of file clients, refer to
            https://github.com/open-mmlab/rflib/blob/master/rflib/fileio/file_client.py
            for more details.
    """
    ...
    def _load_masks_3d(self, results):
        ...
        try:
            ...
            rflib.check_file_exist(pts_instance_mask_path)
    ...
    def _load_semantic_seg_3d(self, results):
        ...
        try:
            ...
            rflib.check_file_exist(pts_semantic_mask_path)
