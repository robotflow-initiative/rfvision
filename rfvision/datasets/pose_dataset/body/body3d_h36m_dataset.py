...
from rfvision.core.evaluation_pose import keypoint_mpjpe
from rfvision.datasets.pose_dataset.base import Kpt3dSviewKpt2dDataset
...
class Body3DH36MDataset(Kpt3dSviewKpt2dDataset):
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            warnings.warn(
                ...
                'Check https://github.com/open-mmlab/rfvision/pull/663 '
    ...
    def _load_camera_param(self, camera_param_file):
        ...
        return rflib.load(camera_param_file)
