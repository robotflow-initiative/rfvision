...
from rfvision.datasets.utils3d import extract_result_dict, get_loading_pipeline_3d
...
class Custom3DDataset(Dataset):
    ...
    def get_classes(cls, classes=None):
        ...
        if isinstance(classes, str):
            ...
            class_names = rflib.list_from_file(classes)
    ...
    def evaluate(self,
        ...
        """
        from rfvision.core.evaluation3d import indoor_eval
        assert isinstance(
    ...
    def _get_pipeline(self, pipeline):
        ...
        if pipeline is None:
            ...
            loading_pipeline = get_loading_pipeline_3d(self.pipeline.transforms)
