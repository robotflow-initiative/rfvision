...
class AlfredDataset(Custom3DDataset):
    r"""Alfred Dataset.
    ...
    Args:
        ...
        test_mode (bool, optional): Whether the dataset is in test mode.
            Defaults to False.
    """
    CLASSES = ('Apple', 'Bowl', 'Bread', 'ButterKnife', 'Cup', 'DishSponge',
        'Egg', 'Fork', 'Knife', 'Ladle', 'Lettuce', 'Mug', 'Pan',
        'PepperShaker', 'Plate', 'Potato', 'Pot', 'SaltShaker', 'SoapBottle',
        'Spatula', 'Spoon', 'Tomato', 'Box', 'CreditCard', 'KeyChain', 'Laptop',
        'Pillow', 'RemoteControl', 'Statue', 'Vase', 'Candle', 'Cloth',
        'HandTowel', 'Plunger', 'ScrubBrush', 'SoapBar', 'SprayBottle',
        'ToiletPaper', 'Towel', 'Newspaper', 'Watch', 'Book', 'CellPhone',
        'WateringCan', 'Glassbottle', 'PaperTowelRoll', 'WineBottle', 'Pencil',
        'Kettle', 'Boots', 'TissueBox', 'Pen', 'AlarmClock', 'BasketBall', 'CD',
        'TeddyBear', 'TennisRacket', 'BaseballBat', 'Footstool'
    )
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            test_mode=test_mode)
        assert 'use_lidar' in self.modality
        assert self.modality['use_lidar']
    ...
    def get_data_info(self, index):
        ...
        if self.modality['use_lidar']:
            ...
            pts_filename = osp.join(self.data_root, 'alfred_instance_data',
                                    info['pts_path'].split('/')[-1][:-4] + '_vert.npy')
