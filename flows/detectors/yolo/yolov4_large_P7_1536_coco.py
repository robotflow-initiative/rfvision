...
model = dict(
    ...
    bbox_head=dict(
        ...
        num_classes=80,
        in_channels=[512, 512, 512, 256, 128],
        out_channels = [1024, 1024, 1024, 512, 256],
        anchor_generator=dict(
            type='YOLOAnchorGenerator',
            base_sizes=[[(812,393), (477,808), (1070,908), (1408,1408)],
                        [(268,248), (232,504), (445,416), (640,640)],
                        [(136,138), (287,114), (134,275), (268,248)],
                        [(57,88), (112,69), (69,177), (136,138)],
                        [(13,17), (22,25), (27,66), (55,41)]],
            strides=[128, 64, 32, 16, 8]),
        bbox_coder=dict(type='YOLOV5BBoxCoder'),
        featmap_strides=[128, 64, 32, 16, 8],
...
test_pipeline = [
    ...
    dict(
        ...
        flip=False,
        transforms=[
            dict(type='LetterResize', img_scale=(1536, 1536)),
