import pytest
import torch
from rflib import assert_params_all_zeros
from rflib.ops import DeformConv2dPack
from torch.nn.modules import AvgPool2d, GroupNorm
from torch.nn.modules.batchnorm import _BatchNorm

from rfvision.models.backbones import ResNet, ResNetV1d
from rfvision.models.backbones.resnet import BasicBlock, Bottleneck
from rfvision.models.utils import ResLayer, SimplifiedBasicBlock
...
def test_resnet_backbone():
    ...
    model = ResNet(
        depth=50, norm_eval=True, init_cfg='torchvision://resnet50')
    model.init_weights()
    model.train()
    assert check_norm_state(model.modules(), False)
