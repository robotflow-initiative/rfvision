...
from rfvision.models.dense_heads import (FCOSHead, FSAFHead, RetinaHead, SSDHead,
                                      YOLOV3Head)
...
def test_retinanet_head_get_bboxes():
    ...
    feats = rflib.load(osp.join(data_path, retina_head_data))
    cls_score = feats[:5]
    bboxes = feats[5:]
...
def test_yolov3_head_get_bboxes():
    ...
    pred_maps = rflib.load(osp.join(data_path, yolo_head_data))
...
def test_fsaf_head_get_bboxes():
    ...
    feats = rflib.load(osp.join(data_path, fsaf_head_data))
    cls_score = feats[:5]
    bboxes = feats[5:]
...
def test_ssd_head_get_bboxes():
    ...
    feats = rflib.load(osp.join(data_path, ssd_head_data))
    cls_score = feats[:6]
    bboxes = feats[6:]
