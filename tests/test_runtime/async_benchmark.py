...
from rfvision.apis import (async_inference_detector, inference_detector,
                        init_detector)
from rfvision.utils.contextmanagers import concurrent
from rfvision.utils.profiling import profile_time
...
async def main():
    ...
    if not os.path.exists(checkpoint_file):
        url = ('https://download.openmmlab.com/rfvisionection/v2.0'
    ...
    img = rflib.imread(os.path.join(project_dir, 'demo/demo.jpg'))
