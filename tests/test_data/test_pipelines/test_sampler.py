...
from rfvision.core.bbox.assigners import MaxIoUAssigner
from rfvision.core.bbox.samplers import (OHEMSampler, RandomSampler,
                                      ScoreHLRSampler)
...
def test_random_sample_result():
    from rfvision.core.bbox.samplers.sampling_result import SamplingResult
