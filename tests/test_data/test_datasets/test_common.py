...
from rfvision.core.evaluation import DistEvalHook, EvalHook
from rfvision.datasets import DATASETS, CocoDataset, CustomDataset, build_dataset
...
def _create_dummy_coco_json(json_name):
    ...
    rflib.dump(fake_json, json_name)
...
def test_dataset_init(config_path):
    ...
    data_config = rflib.Config.fromfile(config_path)
...
@patch('rfvision.apis.single_gpu_test', MagicMock)
@patch('rfvision.apis.multi_gpu_test', MagicMock)
